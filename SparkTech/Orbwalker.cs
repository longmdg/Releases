...
namespace SparkTech
{
    ...
    internal class Orbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_AARange", "AA Circle").SetValue(new Circle(true,
                    System.Drawing.Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_AARange_Enemy", "AA Circle Enemy").SetValue(new Circle(true,
                    System.Drawing.Color.Pink)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_Holdzone", "Holdzone").SetValue(new Circle(true,
                    System.Drawing.Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_MinionHPBar", "Minion HPBar").SetValue(new Circle(true,
                    System.Drawing.Color.Black)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_MinionHPBar_thickness", "^ HPBar Thickness").SetValue(new Slider(1, 1, 3)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_hitbox", "Show HitBoxes").SetValue(new Circle(true,
                    System.Drawing.Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_Lasthit", "Minion Lasthit").SetValue(new Circle(true,
                    System.Drawing.Color.Lime)));
            menuDrawing.AddItem(
                new MenuItem("lxOrbwalker_Draw_nearKill", "Minion nearKill").SetValue(new Circle(true,
        ...
        private static void OnUpdate(EventArgs args)
        {
            ...
            if (Menu.Item("Move_target").GetValue<bool>() && target is Obj_AI_Hero)
            {
                Orbwalk(
                    target.Path.Count() == 0
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            {
                Render.Circle.DrawCircle(MyHero.Position, GetAutoAttackRange(),
                ...
                Menu.Item("lxOrbwalker_Draw_hitbox").GetValue<Circle>().Active)
            {
                ...
                {
                    if (Menu.Item("lxOrbwalker_Draw_AARange_Enemy").GetValue<Circle>().Active)
                        Render.Circle.DrawCircle(enemy.Position, GetAutoAttackRange(enemy, MyHero),
                    ...
                    if (Menu.Item("lxOrbwalker_Draw_hitbox").GetValue<Circle>().Active)
                        Render.Circle.DrawCircle(enemy.Position, enemy.BoundingRadius,
            ...
            {
                Render.Circle.DrawCircle(MyHero.Position,
                    Menu.Item("lxOrbwalker_Misc_Holdzone").GetValue<Slider>().Value,
                ...
                Menu.Item("lxOrbwalker_Draw_nearKill").GetValue<Circle>().Active)
            {
                ...
                foreach (var minion in minionList.Where(minion => minion.IsValidTarget(GetAutoAttackRange() + 500)))
                {
                    ...
                    if (Menu.Item("lxOrbwalker_Draw_Lasthit").GetValue<Circle>().Active &&
                        ...
                        Render.Circle.DrawCircle(minion.Position, minion.BoundingRadius,
